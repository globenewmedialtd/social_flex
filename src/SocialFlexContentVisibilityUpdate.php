...
class SocialFlexContentVisibilityUpdate  {
  ...
  public static function batchUpdateGroupContentVisibility(Group $group, array $changed_visibility, array $new_options) {
    ...
    for ($i = 0; $i < $num_operations; $i++) {
      $operations[] = [
        '\Drupal\social_flex\SocialFlexContentVisibilityUpdate::updateVisibility',
        [
          $entities[$i],
          $new_options,
        ],
    ...
    $batch = [
      ...
      'finished' => '\Drupal\social_flex\SocialFlexContentVisibilityUpdate::updateVisibilityFinishedCallback',
    ];
